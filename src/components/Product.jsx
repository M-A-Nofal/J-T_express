...
const Product = ({product}) => {
  ...
  const productTitle = idString(_id);
  const handleDetails = () => {
      ...
      <div className="w-full border-[1px] px-2 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="text-sm relative w-28 flex justify-end overflow-hidden">
            ...
            <p onClick={()=> dispatch(addToCart(product)) & toast.success(`${product.title} is added to your cart`)} className="absolute z-20 w-[100px] text-gray-500 hover:text-gray-900 flex items-center gap-1 top-0 transform -translate-x-32 group-hover:translate-x-0 transition-transform cursor-pointer duration-500">
              add to cart
              <span>
                <BsArrowRight/>
              </span>
